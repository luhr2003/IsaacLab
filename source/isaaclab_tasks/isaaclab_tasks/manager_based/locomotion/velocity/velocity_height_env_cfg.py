...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        height_commands = ObsTerm(func=mdp.height_command, params={"command_name": "base_height"})
...
class LocomotionVelocityHeightRoughEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the locomotion velocity-tracking environment with height commands.

    This configuration extends the standard velocity tracking environment with height commands
    to enable squatting behavior. The height tracking reward helps expand the feasible operational
    workspace of humanoid robots, enabling them to perform more locomanipulation tasks.
    """
